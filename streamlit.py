...
job = st.number_input('job', min_value=0, max_value=12)
marital = st.number_input('marital', min_value=0, max_value=1)
education = st.number_input('education', min_value=0, max_value=3)
default = st.number_input('default', min_value=0, max_value=1)
balance = st.number_input('balance (in $)', min_value=0, max_value=105000)
housing = st.number_input('housing', min_value=0, max_value=1)
loan = st.number_input('loan', min_value=0, max_value=1)
